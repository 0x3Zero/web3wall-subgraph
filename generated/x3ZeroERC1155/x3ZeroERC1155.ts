...
export class x3ZeroERC1155__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class x3ZeroERC1155 extends ethereum.SmartContract {
  static bind(address: Address): x3ZeroERC1155 {
    return new x3ZeroERC1155("x3ZeroERC1155", address);
  }
  ...
  royaltyInfo(
    _tokenId: BigInt,
    _salePrice: BigInt
  ): x3ZeroERC1155__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new x3ZeroERC1155__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    _tokenId: BigInt,
    _salePrice: BigInt
  ): ethereum.CallResult<x3ZeroERC1155__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new x3ZeroERC1155__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
